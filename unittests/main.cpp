...
//extern uint32_t VEST_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("VEST_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      VEST_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "VEST_TESTING_GENESIS_TIMESTAMP is " << VEST_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
