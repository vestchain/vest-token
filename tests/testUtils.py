...
class Utils:
    ...
    VestClientPath="programs/clvest/clvest"

    VestWalletName="kvestd"
    VestWalletPath="programs/kvestd/"+ VestWalletName

    VestServerName="nodvest"
    VestServerPath="programs/nodvest/"+ VestServerName

    VestLauncherPath="programs/vestio-launcher/vestio-launcher"
    MongoPath="mongo"
    ShuttingDown=False
