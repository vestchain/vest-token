...
CHAINBASE_SET_INDEX_TYPE( vestio::account_control_history_object, vestio::account_control_history_multi_index )

FC_REFLECT( vestio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
