...
CHAINBASE_SET_INDEX_TYPE( vestio::public_key_history_object, vestio::public_key_history_multi_index )

FC_REFLECT( vestio::public_key_history_object, (public_key)(name)(permission) )
